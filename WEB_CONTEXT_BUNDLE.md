...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kou-21.91-kourovka-notebook-problem-21.91-a0b4a63f-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KOU-21.91"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kou-21.91-kourovka-notebook-problem-21.91-a0b4a63f-v1",
      "problem_contract_sha256": "eb2815c4077d33d9c6ed9b279912b958a6a82f8e800bf1a8558951c3d1146a27",
      "problem_id": "problem:um-kou-21.91-kourovka-notebook-problem-21.91-a0b4a63f",
      "route_id": "route:um-kou-21.91-kourovka-notebook-problem-21.91-a0b4a63f-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kou-21.91-kourovka-notebook-problem-21.91-a0b4a63f-source-fidelity-01",
      "graph_id": "graph:um-kou-21.91-kourovka-notebook-problem-21.91-a0b4a63f-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kou-21.91-kourovka-notebook-problem-21.91-a0b4a63f-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kou-21.91-kourovka-notebook-problem-21.91-a0b4a63f-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture: The sum of squares of the degrees of the irreducible $p$-Brauer characters of a finite group $G$ is at least the $p'$-part of $|G|$."
          },
          "statement_sha256": "c0959749cb367bfc4da8e18f42bf907db38f71db53f5e314f2c7644402019f83"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kou-21.91-kourovka-notebook-problem-21.91-a0b4a63f-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kou-21.91-kourovka-notebook-problem-21.91-a0b4a63f-root",
      "route_id": "route:um-kou-21.91-kourovka-notebook-problem-21.91-a0b4a63f-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kou-21.91-850499eed9fc",
        "url": "https://www.unsolvedmath.com/problems/KOU-21.91"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
